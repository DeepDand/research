...
flags.DEFINE_integer('hidden2_units', 75,
                     'Number of units in hidden layer 2.')
flags.DEFINE_integer('hidden3_units', 50,
                     'Number of units in hidden layer 3.')

flags.DEFINE_integer('image_pixels', IMAGE_PIXELS, 'Total number of pixels')
flags.DEFINE_integer('num_classes', 31, 'Number of classes')
...
flags.DEFINE_float('flush_secs', 600, 'Number of seconds to flush summaries')
